...
## 1. 3초과 코드
- 비가중치코드이며 자기보수코드
- 8421코드를 3초과시켜 만든 코드(8421코드에 3(0011)을 더해서 만듬)
## 2. 그레이코드 
...
<img width="200" src="https://user-images.githubusercontent.com/29009929/159112389-ac5841e6-f060-4000-a155-2189a85690c6.png">

<img width="200" src="https://user-images.githubusercontent.com/29009929/159112401-ed322875-976c-47c1-b10c-59445f5f6981.png">

## 3. 해밍코드
- 에러체크 뿐만아니라 수정까지 가능한 코드
- 홀/짝패리티가 문제로 지정되지 않은 경우 기본적으로는 짝수패리티로 계산하는 듯
## 3.1 해밍코드 착오체크비트
- 전부 0인경우는 정상적으로 전달된 것이며, 하나라도 1이 있는 경우 착오가 발생한 경우
- 착오를 찾아 교정하려는 경우, 2진수로 계산하여 위치를 찾아 교정하면됨
- 패리티비트 1357,2367,4567 공식 이용해 계산
- 2<sup>2</sup>,2<sup>1</sup>,2<sup>0</sup>의 순서
- (2<sup>2</sup>,2<sup>1</sup>,2<sup>0</sup>)2 번째 위치를 0이면 1로, 1이면 0으로 수정
## 4. 패리티비트 
- 1의개수가 홀수개가 되는지 짝수개가 되는지 체크하기 위해 추가하는 비트
- 1비트 오류검출이 가능
- 해밍코드에 이용됨
## 4.1 패리티비트 공식 : 2<sup>p</sup> >= p+n+1
